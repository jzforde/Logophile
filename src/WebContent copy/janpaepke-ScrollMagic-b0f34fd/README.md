...
The basic ScrollMagic design pattern is one quiz.app.controller, which has one or more scenes attached to it.
...
```javascript
// init quiz.app.controller
var quiz.app.controller = new ScrollMagic.Controller();
...
new ScrollMagic.Scene({
	...
	.addTo(quiz.app.controller); // assign the scene to the quiz.app.controller
```
