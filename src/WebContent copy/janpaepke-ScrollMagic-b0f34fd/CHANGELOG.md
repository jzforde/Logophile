...
#### bugfixes:
 ...
 - fixed a problem when using the mousewheel to scroll over fixed elements after replacing the default scroll method of the quiz.app.controller
...
#### changes (non-breaking)
 ...
 - new scene event: [add](http://scrollmagic.io/docs/ScrollMagic.Scene.html#event:add) fires when scene is added to a quiz.app.controller
 - new scene event: [remove](http://scrollmagic.io/docs/ScrollMagic.Scene.html#event:remove) fires when scene is removed from a quiz.app.controller
...
#### changes (potentially breaking):
 - ScrollMagic Controllers are now instantiated using `var quiz.app.controller = new ScrollMagic.Controller();`
 - ScrollMagic Scenes are now instantiated using `var scene = new ScrollMagic.Scene();`
 - renamed method `Scene.parent()` to `Scene.quiz.app.controller()`
...
#### features:
 - **new plugin 'debug.addIndicators' (formerly 'jquery.scrollmagic.debug')**
   - indicators can now be added to the scene before it was added to a quiz.app.controller
   ...
   - new quiz.app.controller option 'addIndicators', when a quiz.app.controller is initialized using `new ScrollMagic.Controller({addIndicators: true})` all added scenes will automatically have indicators added to them
 ...
 - **new plugin 'jquery.ScrollMagic'**  
   ...
   - moves ScrollMagic global to `$.ScrollMagic`. To instantiate a quiz.app.controller respectively call `new $.ScrollMagic.Controller()`.
...
#### changes (non-breaking)
 - **scenes are sorted in quiz.app.controller**
   Scenes attached to the same quiz.app.controller are now updated in the order of their start position.
 ...
 - **new quiz.app.controller option `refreshInterval`**
...
#### features:
 - new quiz.app.controller method: [scrollTo](http://scrollmagic.io/docs/ScrollMagic.Controller.html#scrollTo)
 - new quiz.app.controller method: [scrollPos](http://scrollmagic.io/docs/ScrollMagic.Controller.html#scrollPos)
